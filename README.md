...
<picture>
  ...
  <img alt="An agent regression suite running: four eval cases report, one fails with two regressions, and the summary reports the run" src="assets/evals-light.svg" width="820" />
</picture>
